...
function render() {
  ...
  document.querySelector('#app').innerHTML = `<div class="shell"><header><div class="brand"><span class="mark">M</span><div><b>money manage</b><small>个人财务规划 / 消费承受力测算</small></div></div><div class="period">模拟周期　<span>未来 36 个月⌄</span></div><button class="ghost">导出快照 ↗</button></header><main>
