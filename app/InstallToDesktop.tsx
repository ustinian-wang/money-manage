  ...
  if (iosHint) {
    return (
      <div className="relative">
        ...
        {showIosHelp && (
          <div className="fixed inset-x-3 bottom-[max(1rem,env(safe-area-inset-bottom))] z-[70] rounded-2xl border border-slate-200 bg-white p-4 text-left text-sm leading-6 text-slate-600 shadow-2xl sm:absolute sm:inset-x-auto sm:bottom-auto sm:right-0 sm:top-full sm:mt-2 sm:w-64 sm:p-3 sm:text-[11px] sm:leading-5 sm:shadow-xl">
